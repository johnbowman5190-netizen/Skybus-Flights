...
routes_raw = [
    ...
    (304, "KBGR", "KPVD", "Daily"), (306, "KBGR", "KBTV", "Mon,Wed,Fri"),
    (308, "KBGR", "KACK", "Tue,Thu,Sat,Sun"), (310, "KBGR", "KMVY", "Fri,Sat,Sun"),
    (312, "KBGR", "KBDL", "Daily"), (314, "KBGR", "KSYR", "Mon,Wed,Fri"),
    (316, "KBGR", "KROC", "Tue,Thu,Sat"), (318, "KBGR", "KPBG", "Mon,Fri"),

    # Hub 2: KSFB Spokes
    (400, "KSFB", "KEYW", "Daily"), (402, "KSFB", "KPNS", "Daily"),
    (404, "KSFB", "KTLH", "Daily"), (406, "KSFB", "KCHS", "Daily"),
    (408, "KSFB", "KSAV", "Mon,Wed,Fri,Sun"), (410, "KSFB", "KBHM", "Tue,Thu,Sat"),
    (412, "KSFB", "KGSP", "Mon,Wed,Fri"), (414, "KSFB", "KMYR", "Daily"),
    (416, "KSFB", "KAGS", "Tue,Thu,Sat"), (418, "KSFB", "KCAE", "Mon,Wed,Fri,Sun"),

    # Hub 3: TJBQ Spokes
    (500, "TJBQ", "TJSJ", "Daily"), (502, "TJBQ", "TIST", "Daily"),
    (504, "TJBQ", "TISX", "Daily"), (506, "TJBQ", "TJPS", "Daily"),
    (508, "TJBQ", "TJIG", "Daily"), (510, "TJBQ", "TNCM", "Mon,Wed,Fri,Sun"),
    (512, "TJBQ", "MDPC", "Daily"), (514, "TJBQ", "MDSD", "Daily"),
    (516, "TJBQ", "MBPV", "Tue,Thu,Sat"), (518, "TJBQ", "MYNN", "Mon,Fri"),

    # Hub 4: KIWA Spokes
    (600, "KIWA", "KLAS", "Daily"), (602, "KIWA", "KSAN", "Daily"),
    (604, "KIWA", "KPSP", "Daily"), (606, "KIWA", "KTUS", "Daily"),
    (608, "KIWA", "KFLG", "Daily"), (610, "KIWA", "KABQ", "Daily"),
    (612, "KIWA", "KSLC", "Daily"), (614, "KIWA", "KRNO", "Mon,Wed,Fri,Sun"),
    (616, "KIWA", "KFAT", "Tue,Thu,Sat"), (618, "KIWA", "KOAK", "Daily"),

    # Hub 5: KBLI Spokes
    (700, "KBLI", "KGEG", "Daily"), (702, "KBLI", "KYKM", "Mon,Wed,Fri"),
    (704, "KBLI", "KPSC", "Daily"), (706, "KBLI", "KEAT", "Tue,Thu,Sat"),
    (708, "KBLI", "KALW", "Mon,Fri"), (710, "KBLI", "KRDM", "Daily"),
    (712, "KBLI", "KEUG", "Daily"), (714, "KBLI", "KMFR", "Mon,Wed,Fri,Sun"),
    (716, "KBLI", "KOTH", "Tue,Thu,Sat"), (718, "KBLI", "KLWS", "Mon,Wed,Fri"),

    # Hub 6: PAFA Spokes
    (900, "PAFA", "PANC", "Daily"), (902, "PAFA", "PAJN", "Daily"),
    (904, "PAFA", "PAKT", "Mon,Wed,Fri,Sun"), (906, "PAFA", "PASI", "Tue,Thu,Sat"),
    (908, "PAFA", "PABR", "Daily"), (910, "PAFA", "PAOT", "Mon,Wed,Fri"),
    (912, "PAFA", "PAOM", "Daily"), (914, "PAFA", "PABE", "Mon,Wed,Fri,Sun"),
    (916, "PAFA", "PACV", "Tue,Thu,Sat"), (918, "PAFA", "PAPG", "Mon,Fri"),

    # Focus Cities
    (1000, "KSWF", "KALB", "Daily"), (1002, "KSWF", "KSYR", "Daily"),
    (1004, "KSWF", "KROC", "Mon,Wed,Fri"), (1006, "KSWF", "KBUF", "Daily"),
    (1008, "KSWF", "KBTV", "Tue,Thu,Sat"), (1010, "KSWF", "KMHT", "Daily"),
    (1012, "KSWF", "KPVD", "Daily"), (1014, "KSWF", "KORF", "Mon,Wed,Fri,Sun"),
    (1016, "KSWF", "KABE", "Daily"), (1018, "KSWF", "KAVP", "Tue,Thu,Sat"),

    (1100, "KRIC", "KROA", "Daily"), (1102, "KRIC", "KCHO", "Daily"),
    (1104, "KRIC", "KLYH", "Mon,Wed,Fri"), (1106, "KRIC", "KILM", "Daily"),
    (1108, "KRIC", "KEWN", "Tue,Thu,Sat"), (1110, "KRIC", "KOAJ", "Mon,Wed,Fri"),
    (1112, "KRIC", "KTRI", "Daily"), (1114, "KRIC", "KCHS", "Daily"),
    (1116, "KRIC", "KAVL", "Tue,Thu,Sat,Sun"), (1118, "KRIC", "KSBY", "Mon,Fri"),

    (1200, "KMSY", "KBTR", "Daily"), (1202, "KMSY", "KLFT", "Daily"),
    (1204, "KMSY", "KLCH", "Mon,Wed,Fri"), (1206, "KMSY", "KMOB", "Daily"),
    (1208, "KMSY", "KGPT", "Daily"), (1210, "KMSY", "KHSV", "Tue,Thu,Sat"),
    (1212, "KMSY", "KJAN", "Daily"), (1214, "KMSY", "KSHV", "Mon,Wed,Fri,Sun"),
    (1216, "KMSY", "KLIT", "Daily"), (1218, "KMSY", "KPNS", "Daily"),

    (1300, "KGRR", "KTVC", "Daily"), (1302, "KGRR", "KMQT", "Mon,Wed,Fri"),
    (1304, "KGRR", "KPLN", "Tue,Thu,Sat"), (1306, "KGRR", "KAZO", "Daily"),
    (1308, "KGRR", "KLAN", "Daily"), (1310, "KGRR", "KFNT", "Daily"),
    (1312, "KGRR", "KMSN", "Mon,Wed,Fri,Sun"), (1314, "KGRR", "KGRB", "Daily"),
    (1316, "KGRR", "KATW", "Tue,Thu,Sat"), (1318, "KGRR", "KSBN", "Daily"),

    (1400, "KOMA", "KLNK", "Daily"), (1402, "KOMA", "KGRI", "Daily"),
    (1404, "KOMA", "KEAR", "Mon,Wed,Fri"), (1406, "KOMA", "KLBF", "Tue,Thu,Sat"),
    (1408, "KOMA", "KBFF", "Mon,Fri"), (1410, "KOMA", "KSUX", "Daily"),
    (1412, "KOMA", "KFSD", "Daily"), (1414, "KOMA", "KDSM", "Daily"),
    (1416, "KOMA", "KCID", "Mon,Wed,Fri,Sun"), (1418, "KOMA", "KRST", "Tue,Thu,Sat"),

    (1500, "KPVU", "KCDC", "Daily"), (1502, "KPVU", "KSGU", "Daily"),
    (1504, "KPVU", "KEKO", "Mon,Wed,Fri"), (1506, "KPVU", "KPIH", "Daily"),
    (1508, "KPVU", "KIDA", "Daily"), (1510, "KPVU", "KTWF", "Tue,Thu,Sat"),
    (1512, "KPVU", "KBOI", "Daily"), (1514, "KPVU", "KJAC", "Mon,Wed,Fri,Sun"),
    (1516, "KPVU", "KWYS", "Fri,Sat,Sun"), (1518, "KPVU", "KBZN", "Daily"),

    # International
    (800, "KBGR", "CYHZ", "Daily"), (802, "KBGR", "CYUL", "Daily"),
    (804, "KBGR", "CYYT", "Mon,Wed,Fri"), (806, "KBGR", "TXKF", "Tue,Thu,Sat,Sun"),
    (808, "KBGR", "EINN", "Mon,Wed,Fri,Sun"),
    (810, "KSFB", "MYNN", "Daily"), (812, "KSFB", "MKJS", "Daily"),
    (814, "KSFB", "MBPV", "Tue,Thu,Sat"), (816, "KSFB", "MROC", "Mon,Wed,Fri,Sun"),
    (818, "KSFB", "MPTO", "Tue,Thu,Sat"),
    (820, "TJBQ", "MDPC", "Daily"), (822, "TJBQ", "TNCM", "Daily"),
    (824, "TJBQ", "SKBO", "Mon,Wed,Fri"), (826, "TJBQ", "TAPA", "Tue,Thu,Sat"),
    (828, "TJBQ", "MYNN", "Mon,Fri"),
    (830, "KIWA", "MMSD", "Daily"), (832, "KIWA", "MMPR", "Daily"),
    (834, "KIWA", "MMME", "Mon,Wed,Fri,Sun"), (836, "KIWA", "MMGL", "Tue,Thu,Sat"),
    (838, "KIWA", "MMMX", "Daily"),
    (840, "KBLI", "CYVR", "Daily"), (842, "KBLI", "CYYJ", "Daily"),
    (844, "KBLI", "CYYC", "Daily"), (846, "KBLI", "CYEG", "Mon,Wed,Fri,Sun"),
    (848, "KBLI", "MMSD", "Tue,Thu,Sat"),
    (850, "PAFA", "CYXY", "Mon,Wed,Fri"), (852, "PAFA", "CYZF", "Tue,Thu,Sat"),
    (854, "PAFA", "CYEG", "Mon,Wed,Fri,Sun"), (856, "PAFA", "RJAA", "Wed,Fri,Sun"),
    (858, "PAFA", "RKSI", "Tue,Thu,Sat"),
    (860, "KBGR", "EGSS", "Daily"), (862, "KBGR", "LFOB", "Mon,Wed,Fri,Sun"),
    (864, "KBGR", "LIME", "Tue,Thu,Sat"), (866, "KBGR", "EICK", "Mon,Wed,Fri"),
    (868, "KBGR", "LEGE", "Tue,Thu,Sat,Sun"), (870, "KBGR", "EDJA", "Mon,Thu,Sat")
]
...
def find_routes(network, origin, destination, max_connections=10):
    ...
    while queue:
        ...
        for nxt in network:
            if nxt["Origin"] == current_node and nxt["Destination"] not in visited_airports:
...
if st.button("Search Route Options", type="primary"):
    if orig_select == dest_select:
        ...
        routes_found = find_routes(network, orig_select, dest_select, max_connections=max_conn)
